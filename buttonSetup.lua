...
function buildButtons(animator)
  ...
  local buttona = Button.create("a", buttonSize(), buttonPos(0,0), "images/LH.png", "images/LH.png", comboAppend)
  local buttonb = Button.create("b", buttonSize(), buttonPos(0,1), "images/LM.png", "images/LM.png", comboAppend)
  local buttonc = Button.create("c", buttonSize(), buttonPos(0,2), "images/LL.png", "images/LL.png", comboAppend)
  local buttond = Button.create("d", buttonSize(), buttonPos(1,0), "images/RH.png", "images/RH.png", comboAppend)
  local buttone = Button.create("e", buttonSize(), buttonPos(1,1), "images/RM.png", "images/RM.png", comboAppend)
  local buttonf = Button.create("f", buttonSize(), buttonPos(1,2), "images/RL.png", "images/RL.png", comboAppend)
